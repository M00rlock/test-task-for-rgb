...
import { FormActions, RecordActions } from "@/components/crm-actions";
import { Button } from "@/components/ui/button";
import { DEAL_STATUSES, type ClientSummary, type DealStatus, type DealWithClient } from "@/lib/crm-api";
        ...
        <div className="mt-6 flex flex-col gap-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <StatCard
              ...
              hint={`${statusCountLabel(activeDeals)} зараз у роботі`}
            />
            <StatCard
...
function WorkflowCard({ lastSyncedAt }: { lastSyncedAt: string | null }) {
  return (
